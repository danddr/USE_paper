...
pcstack=stack(rpc$map$PC1, rpc$map$PC2)
...
meth_name=c( "Random", "BufferIn", "BufferOut")
...
names(myOut_list) 
myOut_list$group=factor(myOut_list$group, levels = c( "Uniform", "Random", "BufferIn", "BufferOut"))
